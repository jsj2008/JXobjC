...
static struct modEntry
{
    ...
    struct modDescriptor * modInfo;
} _msgControl[] = {{_OBJCBIND_scalar, 0},
                   {_OBJCBIND_pointer, 0},
                   {_OBJCBIND_bag, 0},
                   {_OBJCBIND_compdef, 0},
                   {_OBJCBIND_txtattr, 0},
                   ...
                   {_OBJCBIND_ordcltn, 0},
                   {_OBJCBIND_txtstyle, 0},
                   {_OBJCBIND_identxpr, 0},
                   {_OBJCBIND_assign, 0},
                   {_OBJCBIND_precxpr, 0},
                   {_OBJCBIND_Object, 0},
                   {_OBJCBIND_outofbnd, 0},
                   {_OBJCBIND_rectangl, 0},
