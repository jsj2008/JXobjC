...
static struct modEntry
{
    ...
    struct modDescriptor * modInfo;
                   ...
                   {_OBJCBIND_stktrace, 0},  {_OBJCBIND_outofbnd, 0},
                   {_OBJCBIND_badvers, 0},   {_OBJCBIND_Exceptn, 0},
                   {_OBJCBIND_Message, 0},   {_OBJCBIND_Set, 0},
                   {_OBJCBIND_cltnseq, 0},   {_OBJCBIND_seltab, 0},
                   {_OBJCBIND_notfound, 0},  {_OBJCBIND_setseq, 0},
                   {_OBJCBIND_Object, 0},    {_OBJCBIND_typeinc, 0},
                   {_OBJCBIND_OCString, 0},  {_OBJCBIND_RtObject, 0},
                   {_OBJCBIND_OrdCltn, 0},   {_OBJCBIND_OutOfMem, 0},
                   {_OBJCBIND_sequence, 0},  {_OBJCBIND_mod, 0},
                   {_OBJCBIND_Block, 0},     {_OBJCBIND_memory, 0},
                   {_OBJCBIND_messenger, 0}, {_OBJCBIND_ascfiler, 0},
