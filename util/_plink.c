...
} _msgControl[] = {{_OBJCBIND_objcrt, 0},   {_OBJCBIND_ordcltn, 0},
                   {_OBJCBIND_postlink, 0}, {_OBJCBIND_unknownt, 0},
                   {_OBJCBIND_set, 0},      {_OBJCBIND_cltn, 0},
                   {_OBJCBIND_outofbnd, 0}, {_OBJCBIND_badvers, 0},
                   {_OBJCBIND_Exceptn, 0},  {_OBJCBIND_Message, 0},
                   {_OBJCBIND_cltnseq, 0},  {_OBJCBIND_notfound, 0},
                   {_OBJCBIND_setseq, 0},   {_OBJCBIND_Object, 0},
