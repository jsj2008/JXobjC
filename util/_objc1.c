...
static struct modEntry
{
    ...
    struct modDescriptor * modInfo;
} _msgControl[] = {{_OBJCBIND_scalar, 0},    {_OBJCBIND_prdotxpr, 0},
                   {_OBJCBIND_pointer, 0},   {_OBJCBIND_compdef, 0},
                   {_OBJCBIND_exprstmt, 0},  {_OBJCBIND_dfltstmt, 0},
                   {_OBJCBIND_OutOfMem, 0},  {_OBJCBIND_lex, 0},
                   ...
                   {_OBJCBIND_lexfiltr, 0},  {_OBJCBIND_stktrace, 0},
                   {_OBJCBIND_enumtor, 0},   {_OBJCBIND_keyseq, 0},
                   ...
                   {_OBJCBIND_condxpr, 0},   {_OBJCBIND_Dictionary, 0},
                   {_OBJCBIND_unknownt, 0},  {_OBJCBIND_precdecl, 0},
                   {_OBJCBIND_yacc, 0},      {_OBJCBIND_identxpr, 0},
                   {_OBJCBIND_assign, 0},    {_OBJCBIND_precxpr, 0},
                   {_OBJCBIND_Object, 0},    {_OBJCBIND_outofbnd, 0},
                   {_OBJCBIND_classdef, 0},  {_OBJCBIND_globdef, 0},
                   {_OBJCBIND_initdecl, 0},  {_OBJCBIND_selector, 0},
                   {_OBJCBIND_crt, 0},       {_OBJCBIND_fundef, 0},
                   {_OBJCBIND_funcall, 0},   {_OBJCBIND_expr, 0},
                   {_OBJCBIND_options, 0},   {_OBJCBIND_keywxpr, 0},
                   {_OBJCBIND_node, 0},      {_OBJCBIND_RtObject, 0},
                   {_OBJCBIND_valueseq, 0},  {_OBJCBIND_seltab, 0},
                   ...
                   {_OBJCBIND_array, 0},     {_OBJCBIND_forstmt, 0},
                   {_OBJCBIND_deref, 0},     {_OBJCBIND_binxpr, 0},
                   {_OBJCBIND_util, 0},      {_OBJCBIND_var, 0},
                   {_OBJCBIND_treeseq, 0},   {_OBJCBIND_datadef, 0},
                   {_OBJCBIND_SortCltn, 0},  {_OBJCBIND_gasmop, 0},
                   {_OBJCBIND_dasmstmt, 0},  {_OBJCBIND_dostmt, 0},
                   {_OBJCBIND_gattrib, 0},   {_OBJCBIND_Set, 0},
                   {_OBJCBIND_OrdCltn, 0},   {_OBJCBIND_arrowxpr, 0},
                   ...
                   {_OBJCBIND_gendecl, 0},   {_OBJCBIND_encxpr, 0},
                   {_OBJCBIND_compstmt, 0},  {_OBJCBIND_decl, 0},
