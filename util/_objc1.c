...
static struct modEntry
{
    ...
    struct modDescriptor * modInfo;
                   ...
                   {_OBJCBIND_compdef, 0},  {_OBJCBIND_exprstmt, 0},
                   {_OBJCBIND_dfltstmt, 0}, {_OBJCBIND_OutOfMem, 0},
                   {_OBJCBIND_lex, 0},      {_OBJCBIND_namedecl, 0},
                   {_OBJCBIND_Exceptn, 0},  {_OBJCBIND_Message, 0},
                   {_OBJCBIND_structsp, 0}, {_OBJCBIND_trlunit, 0},
                   {_OBJCBIND_gasmstmt, 0}, {_OBJCBIND_typeof, 0},
                   {_OBJCBIND_contstmt, 0}, {_OBJCBIND_setseq, 0},
                   ...
                   {_OBJCBIND_yacc, 0},     {_OBJCBIND_ordcltn, 0},
                   {_OBJCBIND_identxpr, 0}, {_OBJCBIND_assign, 0},
                   {_OBJCBIND_precxpr, 0},  {_OBJCBIND_Object, 0},
                   {_OBJCBIND_outofbnd, 0}, {_OBJCBIND_classdef, 0},
                   {_OBJCBIND_globdef, 0},  {_OBJCBIND_initdecl, 0},
                   {_OBJCBIND_dictnary, 0}, {_OBJCBIND_selector, 0},
                   {_OBJCBIND_crt, 0},      {_OBJCBIND_fundef, 0},
                   {_OBJCBIND_funcall, 0},  {_OBJCBIND_expr, 0},
                   {_OBJCBIND_options, 0},  {_OBJCBIND_aryvar, 0},
                   ...
                   {_OBJCBIND_datadef, 0},  {_OBJCBIND_sortcltn, 0},
                   {_OBJCBIND_gasmop, 0},   {_OBJCBIND_dasmstmt, 0},
                   {_OBJCBIND_dostmt, 0},   {_OBJCBIND_gattrib, 0},
                   {_OBJCBIND_arrowxpr, 0}, {_OBJCBIND_cppdirec, 0},
                   {_OBJCBIND_keywdecl, 0}, {_OBJCBIND_ascfiler, 0},
                   {_OBJCBIND_relxpr, 0},   {_OBJCBIND_gatrdecl, 0},
                   {_OBJCBIND_objc1, 0},    {_OBJCBIND_switstmt, 0},
                   {_OBJCBIND_funbody, 0},  {_OBJCBIND_rtrnstmt, 0},
                   {_OBJCBIND_listxpr, 0},  {_OBJCBIND_whilstmt, 0},
                   {_OBJCBIND_type, 0},     {_OBJCBIND_fundecl, 0},
                   {_OBJCBIND_def, 0},      {_OBJCBIND_badvers, 0},
                   {_OBJCBIND_parmlist, 0}, {_OBJCBIND_commaxpr, 0},
                   {_OBJCBIND_stardecl, 0}, {_OBJCBIND_gotostmt, 0},
                   {_OBJCBIND_typeinc, 0},  {_OBJCBIND_indexxpr, 0},
                   {_OBJCBIND_addrof, 0},   {_OBJCBIND_selxpr, 0},
                   {_OBJCBIND_sequence, 0}, {_OBJCBIND_stmt, 0},
                   {_OBJCBIND_msgxpr, 0},   {_OBJCBIND_methdef, 0},
