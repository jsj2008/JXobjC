...
extern struct modDescriptor * _OBJCBIND_protodef ();
...
extern struct modDescriptor * _OBJCBIND_ClassDef_Categories ();
...
extern struct modDescriptor * _OBJCBIND_TreeSequence ();
...
extern struct modDescriptor * _OBJCBIND_KeySequence ();
...
extern struct modDescriptor * _OBJCBIND_genspec ();
...
static struct modEntry
{
    ...
    {_OBJCBIND_scalar, 0},      {_OBJCBIND_prdotxpr, 0},
    {_OBJCBIND_pointer, 0},     {_OBJCBIND_compdef, 0},
    {_OBJCBIND_SideTable, 0},   {_OBJCBIND_exprstmt, 0},
    {_OBJCBIND_dfltstmt, 0},    {_OBJCBIND_OutOfMem, 0},
    {_OBJCBIND_lex, 0},         {_OBJCBIND_namedecl, 0},
    {_OBJCBIND_Exceptn, 0},     {_OBJCBIND_Array, 0},
    {_OBJCBIND_Message, 0},     {_OBJCBIND_structsp, 0},
    {_OBJCBIND_gasmstmt, 0},    {_OBJCBIND_trlunit, 0},
    {_OBJCBIND_typeof, 0},      {_OBJCBIND_contstmt, 0},
    {_OBJCBIND_method, 0},      {_OBJCBIND_lexfiltr, 0},
    {_OBJCBIND_stktrace, 0},    {_OBJCBIND_enumtor, 0},
    {_OBJCBIND_sizeof, 0},      {_OBJCBIND_lblstmt, 0},
    {_OBJCBIND_protodef, 0},    {_OBJCBIND_arydecl, 0},
    {_OBJCBIND_dotxpr, 0},      {_OBJCBIND_stclass, 0},
    {_OBJCBIND_pfixxpr, 0},     {_OBJCBIND_casestmt, 0},
    {_OBJCBIND_constxpr, 0},    {_OBJCBIND_condxpr, 0},
    {_OBJCBIND_Dictionary, 0},  {_OBJCBIND_unknownt, 0},
    {_OBJCBIND_precdecl, 0},    {_OBJCBIND_ConstantString, 0},
    {_OBJCBIND_yacc, 0},        {_OBJCBIND_assign, 0},
    {_OBJCBIND_identxpr, 0},    {_OBJCBIND_precxpr, 0},
    {_OBJCBIND_Object, 0},      {_OBJCBIND_outofbnd, 0},
    {_OBJCBIND_classdef, 0},    {_OBJCBIND_globdef, 0},
    {_OBJCBIND_initdecl, 0},    {_OBJCBIND_ClassDef_Categories, 0},
    {_OBJCBIND_SetSequence, 0}, {_OBJCBIND_selector, 0},
    {_OBJCBIND_crt, 0},         {_OBJCBIND_fundef, 0},
    {_OBJCBIND_funcall, 0},     {_OBJCBIND_expr, 0},
    {_OBJCBIND_options, 0},     {_OBJCBIND_TreeSequence, 0},
    {_OBJCBIND_keywxpr, 0},     {_OBJCBIND_node, 0},
    {_OBJCBIND_RtObject, 0},    {_OBJCBIND_seltab, 0},
    {_OBJCBIND_btincall, 0},    {_OBJCBIND_notfound, 0},
    {_OBJCBIND_Block, 0},       {_OBJCBIND_ifstmt, 0},
    {_OBJCBIND_messenger, 0},   {_OBJCBIND_memory, 0},
    {_OBJCBIND_parmdef, 0},     {_OBJCBIND_cltnseq, 0},
    {_OBJCBIND_propdef, 0},     {_OBJCBIND_unyxpr, 0},
    {_OBJCBIND_util, 0},        {_OBJCBIND_forstmt, 0},
    {_OBJCBIND_deref, 0},       {_OBJCBIND_binxpr, 0},
    {_OBJCBIND_var, 0},         {_OBJCBIND_datadef, 0},
    {_OBJCBIND_SortCltn, 0},    {_OBJCBIND_MutableString, 0},
    {_OBJCBIND_gasmop, 0},      {_OBJCBIND_dasmstmt, 0},
    {_OBJCBIND_dostmt, 0},      {_OBJCBIND_gattrib, 0},
    {_OBJCBIND_Set, 0},         {_OBJCBIND_OrdCltn, 0},
    {_OBJCBIND_arrowxpr, 0},    {_OBJCBIND_cppdirec, 0},
    {_OBJCBIND_ascfiler, 0},    {_OBJCBIND_keywdecl, 0},
    {_OBJCBIND_relxpr, 0},      {_OBJCBIND_KeySequence, 0},
    {_OBJCBIND_gatrdecl, 0},    {_OBJCBIND_OCString, 0},
    {_OBJCBIND_objc1, 0},       {_OBJCBIND_switstmt, 0},
    {_OBJCBIND_funbody, 0},     {_OBJCBIND_rtrnstmt, 0},
    {_OBJCBIND_listxpr, 0},     {_OBJCBIND_mod, 0},
    {_OBJCBIND_whilstmt, 0},    {_OBJCBIND_Assoc, 0},
    {_OBJCBIND_fundecl, 0},     {_OBJCBIND_type, 0},
    {_OBJCBIND_def, 0},         {_OBJCBIND_badvers, 0},
    {_OBJCBIND_parmlist, 0},    {_OBJCBIND_ValueSequence, 0},
    {_OBJCBIND_commaxpr, 0},    {_OBJCBIND_stardecl, 0},
    {_OBJCBIND_dictionary, 0},  {_OBJCBIND_ClassDef_NFI, 0},
    {_OBJCBIND_gotostmt, 0},    {_OBJCBIND_addrof, 0},
    {_OBJCBIND_indexxpr, 0},    {_OBJCBIND_selxpr, 0},
    {_OBJCBIND_sequence, 0},    {_OBJCBIND_stmt, 0},
    {_OBJCBIND_typeinc, 0},     {_OBJCBIND_msgxpr, 0},
    {_OBJCBIND_encxpr, 0},      {_OBJCBIND_compstmt, 0},
    {_OBJCBIND_gendecl, 0},     {_OBJCBIND_decl, 0},
    {_OBJCBIND_genspec, 0},     {_OBJCBIND_methdef, 0},
    {_OBJCBIND_symbol, 0},      {_OBJCBIND_blockxpr, 0},
    {_OBJCBIND_enumsp, 0},      {_OBJCBIND_bflddecl, 0},
    {_OBJCBIND_castxpr, 0},     {_OBJCBIND_cltn, 0},
    {_OBJCBIND_pfixdecl, 0},    {0, 0}};
