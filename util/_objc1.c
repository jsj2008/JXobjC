...
static struct modEntry
{
    ...
    struct modDescriptor * modInfo;
                   ...
                   {_OBJCBIND_stktrace, 0},
                   {_OBJCBIND_enumtor, 0},
                   {_OBJCBIND_sizeof, 0},
                   {_OBJCBIND_lblstmt, 0},
                   {_OBJCBIND_protodef, 0},
                   {_OBJCBIND_arydecl, 0},
                   {_OBJCBIND_dotxpr, 0},
                   {_OBJCBIND_stclass, 0},
                   {_OBJCBIND_pfixxpr, 0},
                   ...
                   {_OBJCBIND_expr, 0},
                   {_OBJCBIND_options, 0},
                   {_OBJCBIND_TreeSequence, 0},
                   {_OBJCBIND_keywxpr, 0},
                   {_OBJCBIND_node, 0},
                   {_OBJCBIND_RtObject, 0},
                   {_OBJCBIND_seltab, 0},
                   {_OBJCBIND_btincall, 0},
                   {_OBJCBIND_notfound, 0},
                   {_OBJCBIND_Block, 0},
                   {_OBJCBIND_ifstmt, 0},
                   {_OBJCBIND_messenger, 0},
                   {_OBJCBIND_memory, 0},
                   {_OBJCBIND_parmdef, 0},
                   {_OBJCBIND_cltnseq, 0},
                   {_OBJCBIND_propdef, 0},
